        ...
        public static void Main()
        {
            using (SqlConnection connection = new SqlConnection(Configuration.ConnectionString))
            {
                ...
                string[] createStatements =
                {
                    ...
                    "CREATE TABLE MinionsVillains (MinionId INT FOREIGN KEY REFERENCES " +
                    "Minions(Id),VillainId INT FOREIGN KEY REFERENCES Villains(Id),CONSTRAINT " +
                    "PK_MinionsVillains PRIMARY KEY (MinionId, VillainId))"
                };

                foreach (var statement in createStatements)
                {
                    ExecuteCommand(statement, connection);
                }

                string[] insertStatements =
                {
                    "INSERT INTO Countries ([Name]) VALUES ('Bulgaria'),('England'),('Cyprus')," +
                    "('Germany'),('Norway')",
                    ...
                    "INSERT INTO Minions (Name,Age, TownId) VALUES('Bob', 42, 3),('Kevin', 1, 1)," +
                    ...
                    "INSERT INTO MinionsVillains (MinionId, VillainId) VALUES (4,2),(1,1),(5,7),(3,5)," +
